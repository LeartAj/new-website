...
\section{Sene me i shti}
\begin{theo}{}{}
    Le t\"{e} jet\"{e} $n$ num\"{e}r natyror dhe $S(n)$ shuma e shifrave t\"{e} $n$.
    Kemi
    \begin{itemize}
        \item[(a)] $9\mid S(n)-n$
        \item[(b)] $S(n_1+n_2)\leq S(n_1)+S(n_2)$
        \item[(c)] $S(n_1n_2)\leq \min\{n_1S(n_2),n_2S(n_1)\}$
        \item[(d)] $S(n_1n_2)\leq S(n_1)S(n_2)$
    \end{itemize}
\end{theo}
PSS Engel - 138, 147\\
BMO 1989 P1 - Kur e bon katrort mod 4.
\section{Zgjidhjet e Problemeve}

\section*{Appendix A - Funksioni i Pjes\"{e}s s\"{e} Plot\"{e}}
